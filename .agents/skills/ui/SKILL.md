...
name: ui
description: >-
  A systemic UI design engine for building production-ready interfaces. Activates when building components,
  designing layouts, auditing visual quality, applying themes, or adding animations. Always reads or creates
  DESIGN.md first, writes all output to disk, detects the project stack automatically, and enforces a 9-point
  quality floor before delivering any component.
