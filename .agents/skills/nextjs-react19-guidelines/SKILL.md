---
name: nextjs-react19-guidelines
description: >-
  Production-grade Next.js (App Router) and React 19 instructions and best practices.
  Use when writing TypeScript, Next.js Server Components, Server Actions, Route Handlers,
  and production React 19 architecture.
---
