...
async function updateHeroBanners() {
  try {
    const res = await fetch('http://localhost:5000/api/settings/hero_banners', {
      method: 'PUT',
      headers: {
    ...
    console.log('Successfully updated hero banners:', data);
  } catch (err) {
    console.error('Error updating hero banners:', err.message);
  }
}
